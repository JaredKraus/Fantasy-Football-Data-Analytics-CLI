...
adp_std_2021 = adp_std_2021.rename({'RK': 'RK_ADP', 'PTS':'PROJ PTS','POS RK':'PROJ POS RK' }, axis=1)
...
adp_ppr_2021 = adp_ppr_2021.rename({'RK': 'RK_ADP', 'PTS':'PROJ PTS','POS RK':'PROJ POS RK'}, axis=1)
...
final_df = final_df.rename({'NAME_x': 'NAME', 'POS_x': 'POS', 'TEAM_x': 'TEAM', 'GAMES':'GP', 'TOTAL POINTS':'TTL PTS'}, axis=1)
