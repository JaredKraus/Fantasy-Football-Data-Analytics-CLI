...
ppr_2020['Passing Pts'] = ppr_2020['PASSING YDS']/25 + \
    ppr_2020['PASSING TD']*4 - ppr_2020['PASSING TD']*2
ppr_2020['Rushing Pts'] = ppr_2020['RUSHING YDS']/10 + ppr_2020['RUSHING TD']*6
ppr_2020['Receiving Pts'] = ppr_2020['RECEIVING YARDS']/10 + \
    ppr_2020['RECEIVING TDS']*6 + ppr_2020['RECEIVING RECEPTIONS']
...
std_2020['Passing Pts'] = std_2020['PASSING YDS']/25 + \
    std_2020['PASSING TD']*4 - std_2020['PASSING TD']*2
std_2020['Rushing Pts'] = std_2020['RUSHING YDS']/10 + std_2020['RUSHING TD']*6
std_2020['Receiving Pts'] = std_2020['RECEIVING YARDS'] / \
    10 + std_2020['RECEIVING TDS']*6

# ADP STD
adp_std_2021 = adp_std_2021[adp_std_2021['POS'].isin(offense_list)]
adp_std_2021 = adp_std_2021.rename(
    {'RK': 'RK_ADP', 'PTS': '2021 PROJ PTS', 'POS RK': '2021 PROJ POS RK'}, axis=1)
...
adp_ppr_2021 = adp_ppr_2021.rename(
    {'RK': 'RK_ADP', 'PTS': '2021 PROJ PTS', 'POS RK': '2021 PROJ POS RK'}, axis=1)
...
final_df = final_df.rename({'NAME_x': 'NAME', 'POS_x': 'POS', 'TEAM_x': 'TEAM',
                            'GAMES': '2020 GP', 'TOTAL POINTS': '2020 TTL PTS'}, axis=1)
